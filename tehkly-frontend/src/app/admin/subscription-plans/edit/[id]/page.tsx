  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Editar Plano</h1>
          <p className="text-muted-foreground">Atualize os dados do plano de assinatura</p>
        </div>
      </div>
