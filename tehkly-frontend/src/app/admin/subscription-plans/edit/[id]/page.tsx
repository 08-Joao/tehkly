...
export default function EditSubscriptionPlanPage() {
  ...
  const fetchPlan = async () => {
    try {
      setIsLoading(true);
      const response = await Api.getSubscriptionPlanById(planId);
      ...
      setFormData({
        ...
        quarterlyDiscount: planData.quarterlyDiscount.toString(),
        annualDiscount: planData.annualDiscount.toString(),
        trialDays: planData.trialDays?.toString() || '0',
        isActive: planData.isActive,
        isPublic: planData.isPublic,
      });

      if (planData.cloudFeatures) {
        setCloudFeatures({
          storageGB: planData.cloudFeatures.storageGB.toString(),
          maxUsers: planData.cloudFeatures.maxUsers.toString(),
          maxFileSize: planData.cloudFeatures.maxFileSize.toString(),
          maxBandwidthGB: planData.cloudFeatures.maxBandwidthGB.toString(),
          allowPublicSharing: planData.cloudFeatures.allowPublicSharing,
          allowCustomDomain: planData.cloudFeatures.allowCustomDomain,
          supportLevel: planData.cloudFeatures.supportLevel,
        });
      }

      if (planData.agendeFeatures) {
        setAgendeFeatures({
          maxAppointmentsPerMonth: planData.agendeFeatures.maxAppointmentsPerMonth.toString(),
          maxOrganizations: planData.agendeFeatures.maxOrganizations.toString(),
          maxPointsPerOrganization: planData.agendeFeatures.maxPointsPerOrganization.toString(),
          allowCustomBranding: planData.agendeFeatures.allowCustomBranding,
          allowWhitelabel: planData.agendeFeatures.allowWhitelabel,
          supportLevel: planData.agendeFeatures.supportLevel,
        });
      }

      if (planData.freelaFeatures) {
        setFreelajFeatures({
          maxProjects: planData.freelaFeatures.maxProjects.toString(),
          maxClients: planData.freelaFeatures.maxClients.toString(),
          allowInvoicing: planData.freelaFeatures.allowInvoicing,
          allowTimeTracking: planData.freelaFeatures.allowTimeTracking,
          supportLevel: planData.freelaFeatures.supportLevel,
        });
      }

      if (planData.businessFeatures) {
        setBusinessFeatures({
          supportLevel: planData.businessFeatures.supportLevel,
        });
      }
    } catch (err) {
    ...
    return (
      <div className="flex min-h-[400px] items-center justify-center">
        <div className="text-center">
          <p className="text-lg font-semibold text-destructive">Erro ao carregar plano</p>
  ...
  return (
    <GlassBackground variant="minimal" className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto py-8 px-6 space-y-8 pt-24 max-w-4xl">
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-foreground">Editar Plano</h1>
            </div>
            <p className="text-lg text-muted-foreground">Atualize os dados do plano de assinatura</p>
          </div>
        </motion.div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  id="service"
                  value={serviceLabels[formData.service as Service]}
                  disabled
                />
              </div>
        ...
        {formData.service === Service.CLOUD && (
          <Card>
            <CardHeader>
        ...
        {formData.service === Service.AGENDE && (
          <Card>
            <CardHeader>
        ...
        {formData.service === Service.FREELA && (
          <Card>
            <CardHeader>
        ...
        {formData.service === Service.BUSINESS && (
          <Card>
            <CardHeader>
